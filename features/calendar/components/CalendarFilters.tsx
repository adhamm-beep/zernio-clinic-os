...
export default function CalendarFilters({ events, filters, onChange }: Props) {
  ...
  const statuses: Array<{ value: CalendarEventStatus; en: string; ar: string }> = [{ value: "booked", en: "Booked", ar: "محجوز" }, { value: "confirmed", en: "Confirmed", ar: "مؤكد" }, { value: "arrived", en: "Arrived", ar: "وصل" }, { value: "completed", en: "Completed", ar: "مكتمل" }, { value: "cancelled", en: "Cancelled", ar: "ملغي" }, { value: "no_show", en: "No show", ar: "لم يحضر" }];
  return <div className="grid gap-4 rounded-2xl border bg-white p-4 shadow-sm md:grid-cols-3">
