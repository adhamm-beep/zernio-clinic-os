...
export const permissionMeta: Record<string, PermissionMeta> = {
  ...
  "dashboard.appointments_count.view": { moduleAr: "لوحة التحكم", moduleEn: "Dashboard", labelAr: "عرض عدد المواعيد", labelEn: "View appointment count", descriptionAr: "إظهار بطاقة عدد المواعيد في الواجهة" },
  "dashboard.completed_patients_count.view": { moduleAr: "لوحة التحكم", moduleEn: "Dashboard", labelAr: "عرض المرضى المكتملين", labelEn: "View completed patients", descriptionAr: "إظهار بطاقة عدد المرضى المكتملين" },
  "dashboard.invoice_count.view": { moduleAr: "لوحة التحكم", moduleEn: "Dashboard", labelAr: "عرض عدد الفواتير", labelEn: "View invoice count", descriptionAr: "إظهار بطاقة عدد الفواتير" },
  "dashboard.collections_total.view": { moduleAr: "لوحة التحكم", moduleEn: "Dashboard", labelAr: "عرض إجمالي المحصل", labelEn: "View collected total", descriptionAr: "إظهار قيمة المحصل في بطاقة لوحة التحكم", risk: "sensitive" },
  "dashboard.invoiced_total.view": { moduleAr: "لوحة التحكم", moduleEn: "Dashboard", labelAr: "عرض إجمالي الفواتير بالملخص", labelEn: "View invoiced summary", descriptionAr: "إظهار إجمالي الفواتير في الملخص المالي", risk: "sensitive" },
  "dashboard.paid_total.view": { moduleAr: "لوحة التحكم", moduleEn: "Dashboard", labelAr: "عرض المدفوع بالملخص", labelEn: "View paid summary", descriptionAr: "إظهار المدفوع في الملخص المالي", risk: "sensitive" },
  "dashboard.remaining_total.view": { moduleAr: "لوحة التحكم", moduleEn: "Dashboard", labelAr: "عرض المتبقي بالملخص", labelEn: "View remaining summary", descriptionAr: "إظهار المتبقي في الملخص المالي", risk: "sensitive" },
  ...
  "payments.invoice_count.view": { moduleAr: "المالية", moduleEn: "Finance", labelAr: "عرض عدد الفواتير", labelEn: "View invoice count", descriptionAr: "إظهار بطاقة وعدد الفواتير" },
  "payments.total.view": { moduleAr: "المالية", moduleEn: "Finance", labelAr: "عرض إجمالي الفواتير", labelEn: "View invoice total", descriptionAr: "إظهار إجمالي قيمة الفواتير", risk: "sensitive" },
  "payments.paid_total.view": { moduleAr: "المالية", moduleEn: "Finance", labelAr: "عرض إجمالي المدفوع", labelEn: "View paid total", descriptionAr: "إظهار إجمالي المبالغ المدفوعة", risk: "sensitive" },
  "payments.remaining_total.view": { moduleAr: "المالية", moduleEn: "Finance", labelAr: "عرض إجمالي المتبقي", labelEn: "View remaining total", descriptionAr: "إظهار إجمالي المبالغ المتبقية", risk: "sensitive" },
