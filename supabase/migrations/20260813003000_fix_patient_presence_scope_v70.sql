...
begin
 ...
 select customer.clinic_id,customer.branch_id into v_clinic_id,v_branch_id from public.customers customer where customer.id=v_customer_id;
 if v_clinic_id is null or v_branch_id is null then raise exception 'Patient clinic and branch are required';end if;
